...
public class SparseIntArrayTest extends TestCase {
    ...
    public void testContains() {
        ...
        assertThat(
                AndroidCollections.iterate(mArray).but().to(2).contains(SparseEntries.entry(3, 3)))
                .isTrue();
    ...
    public void testCount() {
        ...
        assertThat(AndroidCollections.iterate(mArray).countOf(SparseEntries.entry(1, 1)))
                .isEqualTo(1);
        assertThat(AndroidCollections.iterate(mArray).reverse().countOf(SparseEntries.entry(1, 1)))
                .isEqualTo(1);
    ...
    public void testImmutable() {
        ...
        final IntSparseIntEntry[] array = AndroidCollections.iterate(mArray).only().key(2)
                                                            .toImmutableArray(
    ...
    public void testIterator() {
        ...
        assertThat(AndroidCollections.iterate(mArray).toImmutableArray(IntSparseIntEntry.class))
    ...
    public void testParcelable() {
        ...
        final ParcelableIntSparseIntEntry[] parcelableArray =
                AndroidCollections.iterate(mArray).only().values(4, 1)
                                  .toParcelableArray(ParcelableIntSparseIntEntry.class);
    ...
    public void testTranslations() {
        ...
        assertThat(AndroidCollections.iterate(array1).toImmutableList())
                .containsExactly(SparseEntries.entry(0, 1), SparseEntries.entry(1, 2),
                                 SparseEntries.entry(2, 3), SparseEntries.entry(3, 4),
                                 SparseEntries.entry(4, 5));
        ...
        assertThat(AndroidCollections.iterate(array2).toImmutableList())
                .containsExactly(SparseEntries.entry(1, 0), SparseEntries.entry(2, 1),
                                 SparseEntries.entry(3, 2), SparseEntries.entry(4, 3),
                                 SparseEntries.entry(5, 4));
        ...
        assertThat(AndroidCollections.iterate(mArray).toImmutableList())
                .containsExactly(SparseEntries.entry(0, 0), SparseEntries.entry(1, 1),
                                 SparseEntries.entry(2, 10), SparseEntries.entry(3, 9),
                                 SparseEntries.entry(4, 4));
        AndroidCollections.iterate(array2).only().keys(2, 3).translateValues(new IntTranslator() {
        ...
        assertThat(AndroidCollections.iterate(mArray).toImmutableList())
                .containsExactly(SparseEntries.entry(0, 0), SparseEntries.entry(1, 1),
                                 SparseEntries.entry(2, 10), SparseEntries.entry(3, 2),
                                 SparseEntries.entry(4, 4));
        AndroidCollections.iterate(array2).only().last(1).translate(new IntTranslator() {
        ...
        assertThat(AndroidCollections.iterate(mArray).toImmutableList())
                .containsExactly(SparseEntries.entry(0, 0), SparseEntries.entry(1, 1),
                                 ...
                                 SparseEntries.entry(4, 10), SparseEntries.entry(5, 2));
        AndroidCollections.iterate(array3).but().last(1).translateKeys(new IntTranslator() {
