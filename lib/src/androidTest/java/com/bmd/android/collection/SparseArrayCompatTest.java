...
public class SparseArrayCompatTest extends TestCase {
    ...
    public void testContains() {
        ...
        assertThat(AndroidCollections.iterate(mArray).containsAll(SparseEntries.entry(3, "3"),
                                                                  SparseEntries.entry(1, "1")))
                .isTrue();
        assertThat(AndroidCollections.iterate(mArray).containsAll(
                Arrays.asList(SparseEntries.entry(3, "3"), SparseEntries.entry(5, "5")))).isFalse();
        assertThat(
        ...
        assertThat(AndroidCollections.iterate(mArray).containsAny(
                Arrays.asList(SparseEntries.entry(5, "5"), SparseEntries.entry(3, "3"),
                              SparseEntries.entry(5, "5"))
        )).isTrue();
        assertThat(AndroidCollections.iterate(mArray).containsAny(SparseEntries.entry(2, "7")))
                .isFalse();
        assertThat(
    ...
    public void testConversions() {
        ...
        assertThat(AndroidCollections.iterate(mArray).only().key(2).toBooleans(
                new Translator<SparseArrayEntry<String>, Boolean>() {
                    ...
                    @Override
                    public Boolean translate(final SparseArrayEntry<String> element) {
        ...
        assertThat(AndroidCollections.iterate(mArray).reverse().toIntegers(
                new Translator<SparseArrayEntry<String>, Integer>() {
                    ...
                    @Override
                    public Integer translate(final SparseArrayEntry<String> element) {
    ...
    public void testCount() {
        ...
        assertThat(AndroidCollections.iterate(mArray).countOf(SparseEntries.entry(1, "1")))
                .isEqualTo(1);
        assertThat(
                AndroidCollections.iterate(mArray).reverse().countOf(SparseEntries.entry(1, "1")))
                .isEqualTo(1);
    ...
    public void testImmutable() {
        ...
        final IntSparseObjectEntry[] array = AndroidCollections.iterate(mArray).only().key(2)
                                                               .toImmutableArray(
    ...
    public void testIterator() {
        ...
        assertThat(AndroidCollections.iterate(mArray).toImmutableArray(IntSparseObjectEntry.class))
                .containsExactly(SparseEntries.entry(0, "0"), SparseEntries.entry(2, "2"),
        ...
        assertThat(AndroidCollections.iterate(mArray).toImmutableArray(IntSparseObjectEntry.class))
                .containsExactly(SparseEntries.entry(0, "0"), SparseEntries.entry(4, "4"));
    ...
    public void testParcelable() {
        ...
        final ParcelableIntSparseObjectEntry[] parcelableArray =
                AndroidCollections.iterate(mArray).only().values("4", "1")
                                  .toParcelableArray(ParcelableIntSparseObjectEntry.class);
    ...
    public void testTranslations() {
        ...
        assertThat(AndroidCollections.iterate(arrayCompat1).values())
                .containsExactly(0, 1, 2, 3, 4);
        assertThat(AndroidCollections.iterate(arrayCompat1)
        ...
        assertThat(AndroidCollections.iterate(arrayCompat1).values())
                .containsExactly(1, 2, 3, 4, 5);
        assertThat(AndroidCollections.iterate(arrayCompat1).toImmutableList())
                .containsExactly(SparseEntries.entry(0, Integer.valueOf(1)),
        ...
        assertThat(AndroidCollections.iterate(arrayCompat2).toImmutableList())
                .containsExactly(SparseEntries.entry(1, Integer.valueOf(0)),
        ...
        assertThat(AndroidCollections.iterate(mArray).toImmutableList())
                .containsExactly(SparseEntries.entry(0, "0"), SparseEntries.entry(1, "1"),
        ...
        final SparseArrayCompat<String> arrayCompat3 =
                AndroidCollections.iterate(mArray).toSparseArray();
        assertThat(AndroidCollections.iterate(arrayCompat3).toImmutableList())
                .containsExactly(SparseEntries.entry(0, "0"), SparseEntries.entry(1, "1"),
                                 SparseEntries.entry(2, "3"), SparseEntries.entry(3, "4"),
                                 SparseEntries.entry(4, "4"));
