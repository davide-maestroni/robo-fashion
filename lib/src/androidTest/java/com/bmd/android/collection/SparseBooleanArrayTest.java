...
public class SparseBooleanArrayTest extends TestCase {
    ...
    public void testContains() {
        ...
        assertThat(AndroidCollections.iterate(mArray).containsAll(SparseEntries.entry(3, false),
                                                                  SparseEntries.entry(1, false)))
                .isTrue();
        assertThat(AndroidCollections.iterate(mArray).containsAll(
                Arrays.asList(SparseEntries.entry(3, false), SparseEntries.entry(5, false))))
                .isFalse();
        assertThat(
        ...
        assertThat(AndroidCollections.iterate(mArray).containsAny(
                Arrays.asList(SparseEntries.entry(5, false), SparseEntries.entry(3, false),
                              SparseEntries.entry(5, false))
        )).isTrue();
        assertThat(AndroidCollections.iterate(mArray).containsAny(SparseEntries.entry(2, false)))
                .isFalse();
        assertThat(
        ...
        assertThat(AndroidCollections.iterate(mArray).but().to(2).containsValue(false)).isTrue();
        assertThat(AndroidCollections.iterate(mArray).only().to(2).reverse().containsValue(false))
                .isTrue();

        assertThat(AndroidCollections.iterate(mArray).but().to(2).firstPositionOfValue(false))
                .isEqualTo(0);
        assertThat(AndroidCollections.iterate(mArray).but().to(2).firstIndexOfValue(false))
                .isEqualTo(3);
        assertThat(AndroidCollections.iterate(mArray).only().to(2).reverse()
                                     .firstPositionOfValue(true)).isEqualTo(0);
        assertThat(
                AndroidCollections.iterate(mArray).only().to(2).reverse().firstIndexOfValue(true))
                .isEqualTo(2);
        assertThat(AndroidCollections.iterate(mArray).only().to(2).reverse()
                                     .firstPositionOfValue(false)).isEqualTo(1);
        assertThat(
                AndroidCollections.iterate(mArray).only().to(2).reverse().firstIndexOfValue(false))
                .isEqualTo(1);
    ...
    public void testConversions() {
        ...
        assertThat(AndroidCollections.iterate(mArray).only().key(2).toBooleans(
        ...
        assertThat(AndroidCollections.iterate(mArray).reverse().toIntegers(
    ...
    public void testCount() {
        ...
        assertThat(AndroidCollections.iterate(mArray).countOf(SparseEntries.entry(1, false)))
                .isEqualTo(1);
        assertThat(
        ...
        assertThat(AndroidCollections.iterate(mArray).values().reverse().countOf(false))
                .isEqualTo(5);
        assertThat(AndroidCollections.iterate(mArray).reverse().values().countOf(false))
                .isEqualTo(5);
        assertThat(AndroidCollections.iterate(mArray).only().first(2).values().countOf(false))
                .isEqualTo(2);
        assertThat(AndroidCollections.iterate(mArray).reverse().only().first(2).values()
                                     .countOf(false)).isEqualTo(2);
        assertThat(AndroidCollections.iterate(mArray).only().first(2).values().reverse()
                                     .countOf(false)).isEqualTo(2);
        assertThat(
    ...
    public void testEquals() {
        ...
        assertThat(AndroidCollections.iterate(mArray)
                                     .isStrictlyEqualTo(AndroidCollections.iterate(arrayCompat)))
                .isTrue();
        assertThat(AndroidCollections.iterate(arrayCompat)
                                     .isStrictlyEqualTo(AndroidCollections.iterate(mArray)))
                .isTrue();
        assertThat(AndroidCollections.iterate(arrayCompat).only().key(2).remove()
                                     .isStrictlyEqualTo(AndroidCollections.iterate(mArray)))
                .isFalse();
        assertThat(AndroidCollections.iterate(mArray)
                                     .isStrictlyEqualTo(AndroidCollections.iterate(arrayCompat)))
    ...
    public void testFilters() {
        ...
        assertThat(AndroidCollections.iterate(mArray).only().last(2).toMap())
                .contains(MapEntry.entry(3, false), MapEntry.entry(4, true));

        assertThat(AndroidCollections.iterate(mArray).only().first(3).only().last(2).toMap())
                .contains(MapEntry.entry(1, false), MapEntry.entry(2, true));

        assertThat(AndroidCollections.iterate(mArray).only().last(3).but().last(1).toMap())
                .contains(MapEntry.entry(2, true), MapEntry.entry(3, false));
        ...
        assertThat(AndroidCollections.iterate(mArray).but().first(2).firstPositionOfValue(false))
                .isEqualTo(1);
        assertThat(AndroidCollections.iterate(mArray).but().first(2).firstIndexOfValue(false))
                .isEqualTo(3);

        assertThat(AndroidCollections.iterate(mArray).keys()).containsExactly(0, 1, 2, 3, 4);
        assertThat(AndroidCollections.iterate(mArray).values())
    ...
    public void testImmutable() {
        ...
        final IntSparseBooleanEntry[] array = AndroidCollections.iterate(mArray).only().key(2)
                                                                .toImmutableArray(
    ...
    public void testParcelable() {
        ...
        final ParcelableIntSparseBooleanEntry[] parcelableArray =
                AndroidCollections.iterate(mArray).only().value(false)
                                  .toParcelableArray(ParcelableIntSparseBooleanEntry.class);
    ...
    public void testTranslations() {
        ...
        assertThat(AndroidCollections.iterate(array1).values())
        ...
        assertThat(AndroidCollections.iterate(array1).toImmutableList())
                .containsExactly(SparseEntries.entry(0, true), SparseEntries.entry(1, false),
        ...
        assertThat(AndroidCollections.iterate(array2).toImmutableList())
                .containsExactly(SparseEntries.entry(1, false), SparseEntries.entry(2, true),
        ...
        AndroidCollections.iterate(array2).only().keys(2, 3)
