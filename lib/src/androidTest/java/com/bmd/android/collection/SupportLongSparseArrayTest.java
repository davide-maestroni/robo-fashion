 ...
 */
public class SupportLongSparseArrayTest extends TestCase {
    ...
    public void testContains() {
        ...
        assertThat(AndroidCollections.iterate(mArray).containsAll(SparseEntries.entry(3L, "3"),
                                                                  SparseEntries.entry(1L, "1")))
                .isTrue();
        assertThat(AndroidCollections.iterate(mArray).containsAll(
                Arrays.asList(SparseEntries.entry(3L, "3"), SparseEntries.entry(5L, "5"))))
                .isFalse();
        assertThat(
        ...
        assertThat(AndroidCollections.iterate(mArray).containsAny(
                Arrays.asList(SparseEntries.entry(5L, "5"), SparseEntries.entry(3L, "3"),
                              SparseEntries.entry(5L, "5"))
        )).isTrue();
        assertThat(AndroidCollections.iterate(mArray).containsAny(SparseEntries.entry(2L, "7")))
                .isFalse();
        assertThat(
        ...
        assertThat(AndroidCollections.iterate(mArray).but().to(2)
                                     .containsAnyKey(Arrays.asList(2L, 3L))).isTrue();
    ...
    public void testConversions() {
        ...
        assertThat(AndroidCollections.iterate(mArray).only().key(2).toBooleans(
                new Translator<LongSparseArrayEntry<String>, Boolean>() {
                    ...
                    @Override
                    public Boolean translate(final LongSparseArrayEntry<String> element) {
        ...
        assertThat(AndroidCollections.iterate(mArray).reverse().toIntegers(
                new Translator<LongSparseArrayEntry<String>, Integer>() {
                    ...
                    @Override
                    public Integer translate(final LongSparseArrayEntry<String> element) {

                        return (int) element.getKey();
                    }
                }
        ).only().first(3).retain().reverse()).containsExactly(2, 3, 4);
        assertThat(AndroidCollections.iterate(mArray).keys()).containsExactly(2L, 3L, 4L);
    }
    ...
    public void testCount() {
        ...
        assertThat(AndroidCollections.iterate(mArray).countOf(SparseEntries.entry(1L, "1")))
                .isEqualTo(1);
        assertThat(
                AndroidCollections.iterate(mArray).reverse().countOf(SparseEntries.entry(1L, "1")))
                .isEqualTo(1);
    ...
    public void testFilters() {
        ...
        assertThat(AndroidCollections.iterate(mArray).only().first(3).only().last(2).toMap())
                .contains(MapEntry.entry(1L, "1"), MapEntry.entry(2L, "2"));

        assertThat(AndroidCollections.iterate(mArray).only().last(3).but().last(1).toMap())
                .contains(MapEntry.entry(2L, "2"), MapEntry.entry(3L, "3"));
        ...
        assertThat(AndroidCollections.iterate(mArray).keys()).containsExactly(0L, 1L, 2L, 3L, 4L);
    ...
    public void testImmutable() {
        ...
        final LongSparseObjectEntry[] array = AndroidCollections.iterate(mArray).only().key(2)
                                                                .toImmutableArray(
    ...
    public void testIterator() {
        ...
        for (final LongSparseArrayEntry<String> entry : AndroidCollections.iterate(mArray)) {
        ...
        AndroidCollections.iterate(mArray).forEach(new Action<LongSparseArrayEntry<String>>() {
        ...
        AndroidCollections.iterate(mArray).doWhile(new Condition<LongSparseArrayEntry<String>>() {
        ...
        assertThat(AndroidCollections.iterate(mArray).toImmutableArray(LongSparseObjectEntry.class))
                .containsExactly(SparseEntries.entry(0L, "0"), SparseEntries.entry(2L, "2"),
        ...
        assertThat(AndroidCollections.iterate(mArray).toImmutableArray(LongSparseObjectEntry.class))
                .containsExactly(SparseEntries.entry(0L, "0"), SparseEntries.entry(4L, "4"));
    ...
    public void testParcelable() {
        ...
        final ArrayList<ParcelableLongSparseObjectEntry<String>> parcelableList =
                AndroidCollections.iterate(mArray).but().keys(Arrays.asList(1L, 2L, 3L)).reverse()
                                  .toParcelableList();
    ...
    public void testTranslations() {
        ...
        assertThat(AndroidCollections.iterate(array1).toImmutableList())
                .containsExactly(SparseEntries.entry(0L, Integer.valueOf(1)),
        ...
        final LongSparseArray<Integer> array2 =
                AndroidCollections.iterate(mArray).translate(new LongTranslator() {
        ...
        assertThat(AndroidCollections.iterate(array2).toImmutableList())
                .containsExactly(SparseEntries.entry(1L, Integer.valueOf(0)),
        ...
        assertThat(AndroidCollections.iterate(mArray).toImmutableList())
                .containsExactly(SparseEntries.entry(0L, "0"), SparseEntries.entry(1L, "1"),
