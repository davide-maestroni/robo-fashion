...
public class SimpleArrayMapTest extends TestCase {
    ...
    public void testContains() {
        ...
        assertThat(AndroidCollections.iterate(mArray).but().to(2)
                                     .contains(SparseEntries.entry(Integer.valueOf(3), "3")))
                .isTrue();
        ...
        assertThat(AndroidCollections.iterate(mArray).but().to(2)
                                     .firstPositionOf(SparseEntries.entry(Integer.valueOf(3), "3")))
                .isEqualTo(0);
        assertThat(AndroidCollections.iterate(mArray).but().to(2)
                                     .firstIndexOf(SparseEntries.entry(Integer.valueOf(3), "3")))
                .isEqualTo(3);
        assertThat(AndroidCollections.iterate(mArray).only().to(2).reverse()
                                     .firstPositionOf(SparseEntries.entry(Integer.valueOf(3), "3")))
                .isEqualTo(-1);
        assertThat(AndroidCollections.iterate(mArray).only().to(2).reverse()
                ...
                .isEqualTo(-1);
        assertThat(AndroidCollections.iterate(mArray).only().to(2).reverse()
                                     .firstPositionOf(SparseEntries.entry(Integer.valueOf(0), "0")))
                .isEqualTo(2);
        assertThat(AndroidCollections.iterate(mArray).only().to(2).reverse()
                                     .firstIndexOf(SparseEntries.entry(Integer.valueOf(0), "0")))
                .isEqualTo(0);
        ...
        assertThat(AndroidCollections.iterate(mArray).containsAll(
                Arrays.asList(SparseEntries.entry(Integer.valueOf(3), "3"),
        ...
        assertThat(AndroidCollections.iterate(mArray).containsAny(
                Arrays.asList(SparseEntries.entry(Integer.valueOf(5), "5"),
                              SparseEntries.entry(Integer.valueOf(3), "3"),
                              SparseEntries.entry(Integer.valueOf(5), "5"))
        )).isTrue();
        assertThat(AndroidCollections.iterate(mArray)
                                     .containsAny(SparseEntries.entry(Integer.valueOf(2), "7")))
                .isFalse();
        assertThat(
    ...
    public void testConversions() {
        ...
        assertThat(AndroidCollections.iterate(mArray).toLongs(
                new Translator<SimpleArrayMapEntry<Integer, String>, Long>() {

                    @Override
                    public Long translate(final SimpleArrayMapEntry<Integer, String> element) {
        ...
        assertThat(AndroidCollections.iterate(mArray).only().key(2).toBooleans(
                new Translator<SimpleArrayMapEntry<Integer, String>, Boolean>() {
                    ...
                    @Override
                    public Boolean translate(final SimpleArrayMapEntry<Integer, String> element) {
        ...
        assertThat(AndroidCollections.iterate(mArray).reverse().toIntegers(
                new Translator<SimpleArrayMapEntry<Integer, String>, Integer>() {
                    ...
                    @Override
                    public Integer translate(final SimpleArrayMapEntry<Integer, String> element) {
    ...
    public void testCount() {
        ...
        assertThat(AndroidCollections.iterate(mArray)
                                     .countOf(SparseEntries.entry(Integer.valueOf(1), "1")))
                .isEqualTo(1);
        ...
        assertThat(AndroidCollections.iterate(mArray).only().first(2).values().countOf("1"))
                .isEqualTo(1);
        assertThat(
                AndroidCollections.iterate(mArray).reverse().only().first(2).values().countOf("1"))
                .isZero();
        assertThat(
                AndroidCollections.iterate(mArray).only().first(2).values().reverse().countOf("1"))
                .isEqualTo(1);
    }
    ...
    public void testImmutable() {
        ...
        final ObjectSparseObjectEntry[] array = AndroidCollections.iterate(mArray).only().key(2)
                                                                  .toImmutableArray(
    ...
    public void testIterator() {
        ...
        for (final SimpleArrayMapEntry<Integer, String> entry : AndroidCollections
                .iterate(mArray)) {
        ...
        assertThat(
                AndroidCollections.iterate(mArray).toImmutableArray(ObjectSparseObjectEntry.class))
                .containsExactly(SparseEntries.entry(Integer.valueOf(0), "0"),
    ...
    public void testParcelable() {
        ...
        assertThat(parcelableList)
                .containsExactly(SparseEntries.parcelableEntry(Integer.valueOf(4), "4"),
        ...
        assertThat(filledArray[0])
                .isEqualTo(SparseEntries.parcelableEntry(Integer.valueOf(2), "2"));
    ...
    public void testTranslations() {
        ...
        assertThat(AndroidCollections.iterate(array1).toImmutableList())
                .containsExactly(SparseEntries.entry(Integer.valueOf(0), Integer.valueOf(1)),
        ...
        final SimpleArrayMap<Integer, Integer> array2 =
                AndroidCollections.iterate(mArray).translate(new Translator<Integer, Integer>() {
        ...
        assertThat(AndroidCollections.iterate(array2).toImmutableList())
                .containsExactly(SparseEntries.entry(Integer.valueOf(1), Integer.valueOf(0)),
        ...
        assertThat(AndroidCollections.iterate(mArray).toImmutableList())
                .containsExactly(SparseEntries.entry(Integer.valueOf(0), "0"),
                                 ...
                                 SparseEntries.entry(Integer.valueOf(4), "4"));
        AndroidCollections.iterate(array2).only().last(1)
                          .translate(new Translator<Integer, Integer>() {
        ...
        AndroidCollections.iterate(array3).but().last(1)
