...
import com.bmd.android.collection.filter.SparseArrayCompatFilterBuilder;
 ...
 */
public interface SparseArrayCompatIterable<V> extends SparseIterable<SparseArrayEntry<V>> {
     ...
     */
    public SparseArrayCompatIterable<V> appendTo(SparseArrayCompat<V> other);

    @Override
    public SparseArrayCompatFilterBuilder<V> but();

    @Override
    public SparseArrayCompatIterable<V> but(Filter<SparseArrayEntry<V>> filter);

    @Override
    public SparseArrayCompatIterable<V> doWhile(Condition<SparseArrayEntry<V>> condition);

    @Override
    public SparseArrayCompatIterable<V> forEach(Action<SparseArrayEntry<V>> action);

    @Override
    public SparseArrayCompatFilterBuilder<V> only();

    @Override
    public SparseArrayCompatIterable<V> only(Filter<SparseArrayEntry<V>> filter);
     ...
     * @return this iterable.
     */
    public SparseArrayCompatIterable<V> fill(Map<? super Integer, ? super V> map);
     ...
     * @return this iterable.
     */
    public <T> SparseArrayCompatIterable<V> fillImmutable(T[] array);
     ...
     * @return this iterable.
     */
    public <T> SparseArrayCompatIterable<V> fillImmutable(T[] array, int offset);
     ...
     * @return this iterable.
     */
    public <T extends Parcelable> SparseArrayCompatIterable<V> fillParcelable(T[] array);
     ...
     */
    boolean isEqualTo(SparseArrayCompat<?> array);
     ...
     * @return this iterable.
     */
    public SparseArrayCompatIterable<V> putInto(SparseArrayCompat<V> other);
     ...
     * @return this iterable.
     */
    public SparseArrayCompatIterable<V> replaceValues(Translator<V, V> translator);
    ...
    /**
     * Returns a new {@link android.support.v4.util.SparseArrayCompat} collection filled with the
     ...
     */
    public <T> SparseArrayCompatIterable<T> translate(IntTranslator keyTranslator,
     ...
     * @return the new iterable.
     */
    public SparseArrayCompatIterable<V> translateKeys(IntTranslator keyTranslator);
     ...
     * @return the new iterable.
     */
    public <T> SparseArrayCompatIterable<T> translateValues(Translator<V, T> valueTranslator);
