...
public class Filters {
     ...
     * using the passed {@link ToIntTranslator} instance.
     *
     ...
     * using the passed {@link ToLongTranslator} instance.
     *
     ...
     * elements using the passed {@link ToBooleanTranslator}
     * instance.
     *
     ...
     * the passed {@link ToIntTranslator} instance.
     *
     * @param translator the translator to int values.
    ...
    /**
     * Creates a filter matching the specified value by translating the iteration elements using
     * the passed {@link ToLongTranslator} instance.
     *
     * @param translator the translator to long values.
    ...
    /**
     * Creates a filter matching the specified value by translating the iteration elements using
     * the passed {@link Translator} instance.
     *
    ...
    /**
     * Creates a filter matching the specified value by translating the iteration elements using
     * the passed {@link ToBooleanTranslator} instance.
     *
     * @param translator the translator to boolean values.
