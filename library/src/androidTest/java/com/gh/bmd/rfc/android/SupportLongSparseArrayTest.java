...
public class SupportLongSparseArrayTest extends TestCase {
    ...
    public void testEquals() {
        ...
        if (VERSION.SDK_INT >= VERSION_CODES.JELLY_BEAN) {
            ...
            assertThat(SparseCollections.iterate(mArray)
                                        .isStrictlyEqualTo(
                                                SparseCollections.iterate(array))).isTrue();
            assertThat(SparseCollections.iterate(array)
                                        .isStrictlyEqualTo(
                                                SparseCollections.iterate(mArray))).isTrue();
            assertThat(SparseCollections.iterate(array)
                                        .only()
                                        .key(2)
                                        .remove()
            ...
            assertThat(SparseCollections.iterate(mArray)
                                        .isStrictlyEqualTo(
                                                SparseCollections.iterate(array))).isFalse();
            ...
            assertThat(SparseCollections.iterate(mArray)
                                        .isStrictlyEqualTo(SparseCollections.iterate(supportArray)))
                    .isTrue();
