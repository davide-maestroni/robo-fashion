...
public class SimpleArrayMapTest extends TestCase {
    ...
    public void testImmutable() {
        ...
        final ObjectSparseObjectEntry[] array = AndroidCollections.iterate(mArray)
                                                                  .only()
                                                                  .key(2)
                                                                  .toImmutableArray(
    ...
    public void testIterator() {
        ...
        for (final SimpleArrayMapEntry<Integer, String> entry : AndroidCollections.iterate(
                mArray)) {
    ...
    public void testTranslations() {
        ...
        AndroidCollections.iterate(array3)
                          .but()
                          .last(1)
