...
public class SupportLongSparseArrayTest extends TestCase {
    ...
    public void testCount() {
        ...
        assertThat(
                AndroidCollections.iterate(mArray).countOf(SparseEntries.entry(1L, "1"))).isEqualTo(
                1);
        assertThat(AndroidCollections.iterate(mArray)
                                     .reverse()
    ...
    public void testEquals() {
        ...
        if (VERSION.SDK_INT >= VERSION_CODES.JELLY_BEAN) {
            ...
            assertThat(AndroidCollections.iterate(mArray)
                                         .isStrictlyEqualTo(AndroidCollections.iterate(
                                                 supportArray))).isTrue();
    ...
    public void testFilters() {
        ...
        assertThat(AndroidCollections.iterate(mArray).values()).containsExactly("0", "1", "2", "3",
                                                                                "4");
        assertThat(AndroidCollections.iterate(mArray).keys().reverse()).containsExactly(4L, 3L, 2L,
                                                                                        1L, 0L);
        assertThat(AndroidCollections.iterate(mArray).reverse().keys()).containsExactly(4L, 3L, 2L,
                                                                                        1L, 0L);
        assertThat(AndroidCollections.iterate(mArray).reverse().keys().reverse()).containsExactly(
                0L, 1L, 2L, 3L, 4L);
    ...
    public void testImmutable() {
        ...
        final LongSparseObjectEntry[] array = AndroidCollections.iterate(mArray)
                                                                .only()
                                                                .key(2)
                                                                .toImmutableArray(
    ...
    public void testParcelable() {
        ...
        final ParcelableLongSparseObjectEntry[] parcelableArray = AndroidCollections.iterate(mArray)
                                                                                    .only()
                                                                                    .values("4",
                                                                                            "1")
                                                                                    .toParcelableArray(
        ...
        final ArrayList<ParcelableLongSparseObjectEntry<String>> parcelableList = AndroidCollections
                .iterate(mArray)
                .but()
